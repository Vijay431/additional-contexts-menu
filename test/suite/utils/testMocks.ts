...
export class VSCodeMocks {
  ...
  public static reset(): void {
    ...
    instance._activeTextEditor = undefined;
  }
  ...
  public showWarningMessage(message: string): void {
    // Mock implementation - store message for verification
    (this as any)._lastWarningMessage = message;
  }
  ...
  // Mock activeTextEditor methods
  public getActiveTextEditor(): vscode.TextEditor | undefined {
    return this._activeTextEditor;
  }

  public setActiveTextEditor(editor: vscode.TextEditor | undefined): void {
    this._activeTextEditor = editor;
  }

  public getLastWarningMessage(): string {
    return (this as any)._lastWarningMessage;
  }
}
