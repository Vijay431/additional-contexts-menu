...
suite('Copy Function', () => {
  test('should copies function text to clipboard when cursor is inside function', async () => {
  ...
  test('should shows error message when cursor is outside any function', async () => {
  ...
  test('should handles arrow function', async () => {
