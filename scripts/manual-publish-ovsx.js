...
async function manualPublish() {
  ...
  try {
    ...
    try {
      ...
      console.log(
        '   URL: https://open-vsx.org/extension/VijayGangatharan/additional-context-menus',
      );
      console.log('');
      ...
      if (errorMessage.includes('401') || errorMessage.includes('Unauthorized')) {
        ...
        console.error(
          '   • Check: https://open-vsx.org/extension/VijayGangatharan/additional-context-menus',
        );
