...
- **Security Note**: Path validation follows the extension's security model to prevent directory traversal attacks. See [Path Validation Security Model](../docs/security/path-validation-model.md) for details on path validation and security safeguards.
...
- [Path Validation Security Model](../docs/security/path-validation-model.md) - Path validation and security safeguards
